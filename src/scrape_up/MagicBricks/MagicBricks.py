...
class MagicBricks:
    ...
    flats_data = magic_bricks.get_ready_to_move(city="Agra")
    print(flats_data)
    ```
    ...
    def get_ready_to_move(self,city):
        """
        Fetches and returns the details of ready-to-move flats in the specified city.

        :param city: The name of the city (e.g., "Agra").
        :type city: str
        :return: A list of dictionaries containing details of ready-to-move flats.
        :rtype: list

        Each dictionary in the list contains the following information:
        - "Title": The title of the flat listing.
        - "Details": A list of dictionaries containing details like number of bedrooms, bathrooms, area, etc.
        - "Description": A brief description of the flat.
        - "Amount": The total price of the flat.
        - "Price Per SQFT": The price per square foot of the flat (if available, otherwise None).
        ...
        try:
            ...
            for items in container.find_all("div",{"class":"mb-srp__list"}):
                ...
                i = 0
                labels = []
                for item in items.find_all("div",{"class":"mb-srp__card__summary__list--item"}):
                    if i<6:
                        label = item.find("div",{"class":"mb-srp__card__summary--label"})
                        value = item.find("div",{"class":"mb-srp__card__summary--value"})
