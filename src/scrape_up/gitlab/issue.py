...
class Issue:
    ...
    def get_title(self):
        try:
            ...
            return {
                "data": title,
                "message": "Retrieved issue title"
            }
        except Exception as e:
            return {
                "data": None,
                "message": f"Error retrieving issue title: {str(e)}"
            }
    ...
    def get_description(self):
        try:
            ...
            return {
                "data": description,
                "message": "Retrieved issue description"
            }
        except Exception as e:
            return {
                "data": None,
    ...
    def get_author(self):
        try:
            ...
            return {
                "data": author,
                "message": "Retrieved issue author"
            }
        except Exception as e:
            return {
                "data": None,
                "message": f"Error retrieving issue author: {str(e)}"
            }
