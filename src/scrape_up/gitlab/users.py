...
class Users:
    ...
    def get_name(self):
        ...
        try:
            ...
            return {
                "data": name,
                "message": f"Retrieved name for user {self.username}"
            }
    ...
    def get_bio(self):
        ...
        try:
            ...
            return {
                "data": bio,
                "message": f"Retrieved bio for user {self.username}"
            }
        except Exception as e:
            return {
                "data": None,
    ...
    def get_repositories(self):
        ...
        try:
            ...
            for repo_element in repo_elements:
                ...
                description = repo_element.find("p", class_="project-description").text.strip()
                repositories.append({
                    "name": name,
