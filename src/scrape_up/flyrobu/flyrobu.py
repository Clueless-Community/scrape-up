...
class Flyrobu:
    ...
    def get_product_details(self, product_name):
      try:
        ...
        description = soup.find("div", class_="product_extra-242").find("div").text.strip()
        features_list = soup.find("div", class_="product_extra-242").find("ul").find_all("li")
        ...
        if technical_details_table:
            ...
            for row in rows[1:]:
                attribute_name = row.find("td", class_="attribute_name").b.text.strip()
                attribute_value = row.find("td", class_="attribute_value").p.text.strip()
