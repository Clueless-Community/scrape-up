    ...
    def test_get_headlines(self):
        ...
        try:
            ...
            if headlines is not None:
                ...
                self.assertEqual(len(indices), len(headlines), "Duplicate indices found in headlines")
    ...
    def test_get_article(self):
        ...
        try:
            ...
            if article is not None:
                self.assertIsInstance(article, dict)  # Check if article is a dictionary or not
                self.assertIn('main_heading', article)  # Does it contain main_heading or not
            ...
            invalid_article = self.bbc_scraper.get_article(invalid_url)  # Should return None
