...
class GithubTest(unittest.TestCase):
    ...
    def test_labels(self):
        pull_request = github.PullRequest(
            username="chromium", repository_name="chromium", pull_request_number=206
        )
    ...
    def test_fork_count(self):
        repository = github.Repository(
            username="Clueless-Community", repository_name="scrape-up"
        )
    ...
    def test_get_environment(self):
        repository = github.Repository(
            username="bobheadxi", repository_name="deployments"
        )
    ...
    def test_assignees(self):
        issue = github.Issue(
            username="Shreya111111", repository_name="Linkscrape", issue_number=1
        )
