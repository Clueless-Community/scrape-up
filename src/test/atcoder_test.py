import unittest
import json
from scrape_up.atcoder import Atcoder
...
class TestAtcoder(unittest.TestCase):
    ...
    def test_get_profile(self):
        ...
        try:
            ...
            self.assertIsInstance(
                profile_data, dict, "Profile data should be a dictionary"
            )
            ...
            expected_keys = [
                ...
                "Algorithm_Rank",
                "Algorithm_Rating",
                "Algorithm_Highest_Rating",
                "Algorithm_Rated_Matches_",
                "Algorithm_Last_Competed",
                "Heuristic_Rank",
                "Heuristic_Rating",
                "Heuristic_Highest_Rating",
                "Heuristic_Rated_Matches_",
                "Heuristic_Last_Competed",
            ]
    ...
    def test_get_contests(self):
        ...
        try:
            ...
            self.assertIsInstance(
                contests, dict, "Contests data should be a dictionary"
            )
            ...
            for key in expected_keys:
                ...
                self.assertIsInstance(
                    contests[key], dict, f"The value for '{key}' should be a dictionary"
                )
