...
class ICCTest(unittest.TestCase):
    ...
    def test_team_rankings(self):
        ...
        self.assertTrue(
            all(
                isinstance(team, dict) and "rank" in team and "team" in team
                for team in response
            ),
            "Incorrect format for team rankings",
        )
    ...
    def test_player_ranking(self):
        ...
        self.assertTrue(
            all(
                isinstance(player, dict) and "rank" in player and "name" in player
                for player in response
            ),
            "Incorrect format for player rankings",
        )
    ...
    def test_team_rankings_women(self):
        ...
        self.assertTrue(
            ...
            "Incorrect format for team rankings for women",
        )
    ...
    def test_player_ranking_women(self):
        ...
        self.assertTrue(
            ...
            "Incorrect format for player rankings for women",
        )
